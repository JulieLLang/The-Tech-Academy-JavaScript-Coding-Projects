...
// the next function will add a particular total to the running total
// the syntax will be text1 = text1 + something + "<br>";
...
function getReceipt() {
	// These initialize as empty strings but get passed from  
...
// add the item cost to our running total to get the new
...
// This clears the form selections to their defaults and then sets the 
